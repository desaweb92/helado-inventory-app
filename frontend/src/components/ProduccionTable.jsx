                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        ...
                        {item.tipo === 'superEspecial' && 'Super Especial'}
                      </span>
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-green-600 font-medium">${item.precioMayor}</td>
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-green-600 font-medium">${item.precioDetal}</td>
              ...
              <div key={index} className="bg-white p-4 rounded-lg shadow border border-gray-200">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600 font-medium">${item.precioMayor}</p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-gray-500">Precio Detal</p>
                    <p className="text-sm text-green-600 font-medium">${item.precioDetal}</p>
                  </div>
